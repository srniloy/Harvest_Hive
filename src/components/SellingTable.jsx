...
const SellingTable = (props) => {
    ...
    const fetchSales = async ()=>{
        ...
        'http://localhost:3000/api/get/get_sales',
        postData
        )
    ...
    const updateSales = async ()=>{
            ...
            const res = await fetch(
            'http://localhost:3000/api/update/sales_update',
            postData
            )
            const response = await res.json()
        ...
        const res = await fetch(
            'http://localhost:3000/api/delete/sales_delete',
            postData
        )
        const response = await res.json()
        console.log(response)
        ...
        const updateTotalSales = async (project_id, total_sales)=>{
          ...
          const res = await fetch(
            'http://localhost:3000/api/update/total_sales_update',
            postData
          )
          const response = await res.json()
      }
