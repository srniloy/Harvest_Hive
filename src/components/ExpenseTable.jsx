...
const ExpenseTable = (props) => {
    ...
    const fetchExpenses = async ()=>{
        ...
        'http://localhost:3000/api/get/get_expenses',
        postData
        )
    ...
    const updateExpense = async ()=>{
          ...
          const res = await fetch(
            'http://localhost:3000/api/update/expense_update',
            postData
          )
          const response = await res.json()
      ...
      const deleteExpense = async (data)=>{
        ...
        const res = await fetch(
          'http://localhost:3000/api/delete/expense_delete',
          postData
        )
        const response = await res.json()
        console.log(response)
    ...
    const updateTotalExpense = async (project_id, total_cost)=>{
      ...
      const res = await fetch(
        'http://localhost:3000/api/update/total_expense_update',
        postData
      )
      const response = await res.json()
  }
