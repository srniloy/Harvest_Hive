...
const BuyingTable = (props) => {
    ...
    React.useEffect(() => {
        // fetchSales()
        setSalesData([props.data.product])
    ...
    const addOffers= async ()=>{
        ...
        '/api/users/wholesaler/add/add_offers',
        postData
        )
                    ...
                    .map((row) => {
                        ...
                        <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                            {columns.map((column) => {
                                if(column.id == 'Step'){
                                ...
                                else if(column.id == 'sales_status'){
                                    ...
                                    return(
                                        <TableCell key={column.id} align={column.align}>
                                            <Button disabled={!(row['sales_status'] == 'Ready To Sell')} variant='outlined' onClick={()=>{
                                                setOfferData(ex=>({
                                                    ...ex,
                                                    price: '',
                                                    quantity: '',
