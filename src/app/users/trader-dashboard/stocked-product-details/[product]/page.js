...
const ProjectDetails = ({ params }) => {
  ...
  React.useEffect(() => {
    if (total.total_costs != '0' && total.total_revenue != '0') {
      updateTotal()
    }
  }, [total])
            ...
            <div class="fpd-calc-item">
              <div class="w-layout-hflex fpd-total-calc-flex"><img src="/images/acquisition.png" loading="lazy" alt="" class="fpd-total-calc-icons" />
                <div class="fpd-total-calc-text">
                  ...
                  <h4 class="fpd-total-calc-h5">{parseInt(total.total_revenue).toLocaleString('en-us')} <span class="fpd-total-calc-h5-span"></span></h4>
                </div>
              </div>
            </div>
            <div class="fpd-calc-item">
              <div class="w-layout-hflex fpd-total-calc-flex"><img src="/images/revenue.png" loading="lazy" alt="" class="fpd-total-calc-icons" />
                <div class="fpd-total-calc-text">
                  ...
                  <h4 class="fpd-total-calc-h5">{parseInt(total.total_revenue) - parseInt(total.total_costs)}<span class="fpd-total-calc-h5-span"></span></h4>
                </div>
              </div>
            </div>
            <div class="fpd-calc-item">
