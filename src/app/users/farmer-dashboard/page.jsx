...
import BusinessAnalytics from '@components/farmer/BusinessAnalytics';
        ...
        <div class="w-layout-hflex farmer-dashboard-flex">
          <div class="frmr-profile-part">
            <div class="frmr-profile-img-style">
              {/* <img src="/images/bangla.png" class="frmr-profile-img"/> */}
          ...
          <div class="frmr-other-part">
            <div class="w-layout-hflex frmr-tab-link-container">
              ...
              <div class="frmr-tab-link-wrapper">
                <a class="fpd-tab-link" onClick={(e) => frmrTabClickAction(e)}>Projects</a>
              </div>
              <div class="frmr-tab-link-wrapper">
                <a class="fpd-tab-link" onClick={(e) => frmrTabClickAction(e)}>Transaction</a>
              </div>
              {/* <div class="frmr-tab-link-wrapper">
                <a class="fpd-tab-link" onClick={(e) => frmrTabClickAction(e)}>Traders</a>
              </div> */}
            </div>
            <div class="frmr-tab-container" style={{
              maxWidth: "100%",
            }}>
              {tabContainer}
            </div>
