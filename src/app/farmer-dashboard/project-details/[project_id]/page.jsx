...
const ProjectDetails = ({params}) => {
  ...
  const AddExpense = async ()=>{
    if(
      ...
      const res = await fetch(
        'http://localhost:3000/api/add/frmr_add_expense',
        postData
      )
      const response = await res.json()
  ...
  const addProjectSales = async ()=>{
    ...
    const res = await fetch(
      'http://localhost:3000/api/add/add_sales_data',
      postData
    )
    const response = await res.json()
    console.log(response)
...
const deleteProject = async ()=>{
  ...
  const res = await fetch(
    'http://localhost:3000/api/delete/delete_project',
    postData
  )
  const response = await res.json()
  console.log(response)
...
const updateProjectInfo = async ()=>{
  ...
  const res = await fetch(
    'http://localhost:3000/api/update/update_project',
    postData
  )
  const response = await res.json()
  console.log(response)
